...
def train_bpe_tinystories():
    """
    Train a byte-level BPE tokenizer on the TinyStories dataset (10k vocab)
    and serialize the vocabulary and merges to disk.
    """

    # === Configuration ===
    input_path = "../dataset/tinystories/TinyStoriesV2-GPT4-train.txt"
    vocab_size = 10000
    ...
    # 因为：
    # TinyStories 数据中包含很长的 ssssssssss 模式（例如蛇的声音、某种重复字符）
